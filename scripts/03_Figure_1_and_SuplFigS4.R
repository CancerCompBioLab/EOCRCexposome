...
CRC_450mrs <- read.csv("Results/meta_analysis/Comb_meta_CRC_450k.csv", header=T)
CRC_450mrs$trait <- paste("MRS450_CRC", CRC_450mrs$SampleID, sep="_")
CRC_450mrs$esi <- ifelse(CRC_450mrs$pval > 0.05, 0, CRC_450mrs$Beta)
CRC_450mrs <- CRC_450mrs[, c("esi", "trait", "name")]
names(CRC_450mrs) <- c("Esti", "variable", "name") 

new <- rbind(COAD,READ,rectal,Colon,CRC_450mrs, CRC)
...
names <- c("COAD F001",   "COAD F005", "COAD F01", "COAD GW", "COAD P1E5",
           ...
           "CRC 450K F001", "CRC 450K F005", "CRC 450K F01", "CRC 450K GW", "CRC 450K P1E5") 
...
data_wide <- data_wide[,c("COAD GW", "COAD P1E5", "COAD F01", "COAD F005", "COAD F001", 
                          ...
                          "CRC 450K GW", "CRC 450K P1E5", "CRC 450K F01", "CRC 450K F005", "CRC 450K F001",
                          "CRC GW", "CRC P1E5", "CRC F01", "CRC F005", "CRC F001")] 
...
met <- c("TCGA-COAD", "TCGA-COAD", "TCGA-COAD", "TCGA-COAD", "TCGA-COAD", 
         ...
         "Meta-analysis CRC 450K", "Meta-analysis CRC 450K", "Meta-analysis CRC 450K", "Meta-analysis CRC 450K", "Meta-analysis CRC 450K",
         "Meta-analysis CRC", "Meta-analysis CRC", "Meta-analysis CRC", "Meta-analysis CRC", "Meta-analysis CRC")
